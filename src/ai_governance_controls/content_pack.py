...
PACK = {
    ...
    "legal_rules": {"EU": {"instrument": "EU AI Act", "provision": "Annex III and Article 6", "sourceUrl": "https://eur-lex.europa.eu/eli/reg/2024/1689/oj/eng", "status": "review_required", "note": "Sector and function facts are required; keywords alone do not establish applicability."}, "NIST": {"instrument": "NIST AI RMF", "provision": "Govern/Map/Measure/Manage", "sourceUrl": "https://www.nist.gov/itl/ai-risk-management-framework", "status": "voluntary", "note": "Framework guidance is not a statutory obligation."}},
