...
from .release_a import governance_search, governance_get, ai_control_review, ai_evidence_validate, ai_report_export, ai_mcp_review, ai_risk_classify_v2, ai_output_validate, ai_red_team_v2, ai_eval_review
...
mcp.tool()(ai_risk_classify_v2)
mcp.tool()(ai_output_validate)
mcp.tool()(ai_red_team_v2)
mcp.tool()(ai_eval_review)
